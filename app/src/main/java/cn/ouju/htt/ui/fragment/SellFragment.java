...
public class SellFragment extends BaseFragment implements OnRefreshLoadMoreListener {
    ...
    public static SellFragment getInstance(HttpListener listener, BaseActivity.MyHandler handler) {
    ...
    protected void initView() {
        ...
        tradingTitle.setText(getString(R.string.home_sell));
        CommonService.query("Dti/price", null, null, listeners, handlers);
    ...
    protected void initData() {
        ...
        tradingTvFix.setText(getString(R.string.sell_list));
        ...
        search.setHint(getString(R.string.search_seller_tel));
        ...
        adapter.setBack(new TradingAdapter.CallBack() {
            ...
            public void sellAndBuy(final int position) {
                if (!TextUtils.isEmpty(UserUtils.getString("user_no", null))) {
                    ...
                    CommonService.query("Dti/saleDetail", params, null, listeners, handlers);
                        ...
                        get.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (!TextUtils.isEmpty(sms)) {
                                    ...
                                    params.put("sms", "86");
                                CommonService.query("Home/getCode", params, null, SellFragment.this, handlers);
                            }
                        });
                            ...
                            public void onClick(View v) {
                                ...
                                if (!TextUtils.isEmpty(c)) {
                                    if (!TextUtils.isEmpty(p)) {
                                        ...
                                        CommonService.query("Dti/sale", params, null, listeners, handlers);
                                    } else
            ...
            if (t[1] instanceof JsonUtils) {
                ...
                if (jsonUtils.getCode().equals("200")) {
                    if (t[0].equals("Dti/price")) {
                        ...
                        if (title == 1) {
                            tradingTitle.setText(getString(R.string.sell_closed));
                        } else {
                            tradingTitle.setText(getString(R.string.home_sell));
                        }
                        ...
                        builder.setTitle(getString(R.string.input_safe_psw)).setView(et).setNegativeButton(getString(R.string.cancel), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (!TextUtils.isEmpty(psw)) {
                                    ...
                                    CommonService.query("Dti/confirmBuy", params, null, listeners, handlers);
                                } else
